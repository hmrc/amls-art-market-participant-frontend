...
class DateTransactionOverThresholdController @Inject()(
                                        ...
                                        formProvider: DateTransactionOverThresholdFormProvider,
                                        val controllerComponents: MessagesControllerComponents,
                                        view: DateTransactionOverThresholdView
  ...
  def onPageLoad(mode: Mode): Action[AnyContent] = (identify andThen getData andThen requireData) {
    implicit request =>
      ...
      val preparedForm = request.userAnswers.get(DateTransactionOverThresholdPage) match {
        case None => form
