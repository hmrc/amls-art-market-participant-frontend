...
class IdentifyLinkedTransactionsControllerSpec extends SpecBase with MockitoSugar {
  ...
  "IdentifyLinkedTransactions Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[IdentifyLinkedTransactionsView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(IdentifyLinkedTransactionsPage, true).success.value
