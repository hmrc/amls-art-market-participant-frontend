...
class TypeOfParticipantDetailControllerSpec extends SpecBase with MockitoSugar {
  ...
  "TypeOfParticipantDetail Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[TypeOfParticipantDetailView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(TypeOfParticipantDetailPage, "answer").success.value
