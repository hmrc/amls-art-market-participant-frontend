...
class PercentageExpectedTurnoverSpec extends WordSpec with MustMatchers with ScalaCheckPropertyChecks with OptionValues {

  "PercentageExpectedTurnover" must {
