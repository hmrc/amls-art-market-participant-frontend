  ...
  "Navigator" when {
    "in Normal mode" must {
      "go from Type of Participant to Type Of Participant Detail when specifying something else" in {
        ...
        navigator
          .nextPage(TypeOfParticipantPage, NormalMode, answers)
      ...
      "go from Type Of Participant Detail to Art Sold Over Threshold" in {
        ...
        navigator
          .nextPage(TypeOfParticipantDetailPage, NormalMode, answers)
          .mustBe(routes.SoldOverThresholdController.onPageLoad(NormalMode))
      }
      ...
      "go from Date Transaction Over Threshold to Identify Linked Transactions page" in {
        ...
        navigator
          .nextPage(DateTransactionOverThresholdPage, NormalMode, answers)
          .mustBe(routes.IdentifyLinkedTransactionsController.onPageLoad(NormalMode))
      }
      ...
      "go from Identify Linked Transactions to Percentage Turnover From Sales Over Threshold page" in {
        ...
        navigator
          .nextPage(IdentifyLinkedTransactionsPage, NormalMode, answers)
      ...
      "go from Percentage Turnover Sales Over Threshold to Check your answers page" in {
        ...
        navigator
          .nextPage(PercentageExpectedTurnoverPage, NormalMode, answers)
      ...
      "default to What You Need page from any other page" in {
        ...
        navigator
          .nextPage(Foo, NormalMode, UserAnswers())
    ...
    "in Check mode" must {
      ...
      "go from Type of Participant to Type Of Participant Detail when specifying something else" in {
        ...
        navigator
          .nextPage(TypeOfParticipantPage, CheckMode, answers)
      ...
      "go from Date Transaction Over Threshold to Check Your Answers" in {
        ...
        navigator
          .nextPage(DateTransactionOverThresholdPage, CheckMode, answers)
          .mustBe(routes.CheckYourAnswersController.onPageLoad())
      }
      ...
      "go from Identify Linked Transactions to Check Your Answers" in {
        ...
        navigator
          .nextPage(IdentifyLinkedTransactionsPage, CheckMode, answers)
          .mustBe(routes.CheckYourAnswersController.onPageLoad())
      }
      ...
      "go from Percentage Turnover Sales Over Threshold to Check your answers page" in {
        ...
        navigator
          .nextPage(PercentageExpectedTurnoverPage, CheckMode, answers)
          .mustBe(routes.CheckYourAnswersController.onPageLoad())
      }
    }
  }
