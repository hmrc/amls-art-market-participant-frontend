...
class DateTransactionOverThresholdViewSpec extends QuestionViewBehaviours[LocalDate] {
  ...
  "DateTransactionOverThresholdView view" must {
    ...
    "include the correct content" in {
      ...
      assertTitleEqualsMessage(document, "title", "When was the first sale of art for €10,000 or more after 10 January 2020?")
      assertPageTitleEqualsMessage(document, "When was the first sale of art for €10,000 or more after 10 January 2020?")
    }
  }
}
